...
import andreapascarella.u5d15project.payloads.ErrorsAsListDTO;
import andreapascarella.u5d15project.payloads.ErrorsDTO;
...
public class ErrorsHandler {
    ...
    public ErrorsAsListDTO handleValidationException(ValidationException ex) {

        return new ErrorsAsListDTO(ex.getMessage(), LocalDateTime.now(), ex.getErrorsMessages());
    }
